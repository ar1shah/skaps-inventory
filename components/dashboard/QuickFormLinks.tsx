...
function FormLink({
  ...
  if (!isConfigured) {
    return (
      <div className="rounded-md border border-dashed border-amber-300 bg-amber-50/60 px-3 py-1.5 text-xs text-amber-800">
  ...
  return (
    <a
      ...
      className="group flex items-center justify-between rounded-md border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-slate-700 transition-colors hover:border-blue-300 hover:bg-blue-50/40 hover:text-blue-700"
    >
